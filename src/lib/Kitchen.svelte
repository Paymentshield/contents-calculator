...
<div class="flex flex-col p-4">
  {#each $KitchenStore as item (item.id)} 
    ...
    <div class="relative inline-block w-full text-gray-700 mt-2">
      <select bind:value="{item.selectedPrice}" class="w-full h-10 pl-3 pr-6 text-base placeholder-gray-600 border rounded-md appearance-none focus:shadow-outline" placeholder="Regular input">
